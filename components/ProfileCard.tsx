    ...
    return (
        <div style={{
            ...
            <img
                ...
                alt={nombre}
                style={{ width: '72px', height: '72px', borderRadius: '50%', border: '3px solid #fdb913' }}
            />
            ...
            <span style={{
                ...
                padding: '3px 12px', borderRadius: '20px', fontSize: '.75rem', fontWeight: 600
            }}>
            ...
            <div style={{ marginTop: '14px', display: 'flex', flexWrap: 'wrap', gap: '6px' }}>
                {tecnologias.map((tech: string) => (
                    <span key={tech} style={{
                        ...
                        padding: '2px 8px', borderRadius: '4px', fontSize: '.73rem', fontWeight: 600
                    }}>
                        {tech}
                    </span>
                ))}
